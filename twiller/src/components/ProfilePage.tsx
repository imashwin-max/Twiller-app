  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="px-4 pb-4 mt-12">
        ...
        <div className="flex items-center space-x-3 mt-3 p-3 bg-gray-900 rounded-xl border border-gray-800">
          <span className="text-white text-sm font-semibold">🔔 Tweet Notifications</span>
